...
import com.compose.sample.onlinetictactoe.presentation.TicTacToeField
import com.compose.sample.onlinetictactoe.presentation.TicTacToeViewModel
import com.compose.sample.onlinetictactoe.ui.theme.OnlinetictactoeTheme
        ...
        setContent {
            OnlinetictactoeTheme {
                ...
                Surface(
                    ...
                    val showError by viewModel.showConnectionError.collectAsState()
                    ...
                    Box(
                        ...
                        TicTacToeField(
                            state = state, onTapInField = viewModel::finishTurn,
                            modifier = Modifier
                                .fillMaxWidth()
                                .aspectRatio(1f)
                                .padding(16.dp)
